...
<head>
    ...
    <body data-layout-mode="default" data-theme="light" data-layout-width="fluid" data-topbar-color="dark" data-menu-position="fixed" data-leftbar-color="light" data-leftbar-size='default' data-sidebar-user='false'>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <a onclick="form_nuevo('form_nuevo_producto')" id="myBtn" type="button" class="btn btn-sm btn-success waves-effect waves-light float-end" data-bs-toggle="modal" data-bs-target="#con-close-modal">
                                            <i style="color: white" data-feather="plus" class="icon-dual"></i>   
                                        </a> 
                                        <h4 class="header-title mb-4">Productos</h4>
                                        <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                            ...
                                            <tbody> 
                                                <?php $cont=0; foreach ($producto as $p ) { $cont++; ?>
                                                <tr>
                                                    <td><?= $cont ?></td>
                                                    <td><?= $p->descripcion ?></td>
                                                    ...
                                                    <td><?= $p->precioventa ?></td> 
                                                    <td><?= $p->situestado ?></td> 
                                                    <td> <i data-feather="edit" data-bs-toggle="modal" data-bs-target="#edit-close-modal" class="icon-dual" onclick="form_editar('form_editarproducto','<?= $p->idproducto ?>')"></i>
                                                    <i data-feather="trash-2" class="icon-dual" data-bs-toggle="modal" data-bs-target="#borrar-close-modal"onclick="borrar('borrar_producto','producto',<?= $p->idproducto ?>)"></i></td> 
                                                </tr>
                                                <?php } ?> 
                                            </tbody>
                                        </table>
        ...
        @extends('compras.catalogo.producto.modal') 
        <!-- END wrapper -->
    </body>
