                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title" style="font-weight: bold">ADELANTO DE PAGOS</h4>
                                        <p class="text-muted font-13 mb-1">
                                            Muestra del listado de montos abonados por alquiler de equipos
                                        </p> 
                                        ...
                                        <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                            ...
                                            <tbody>
                                                <?php $cont=0; foreach ($adelanto as $a ) { ?>
                                                <tr>
                                                    <td><?= $a->entrega ?></td>
                                                    <td><?= $a->equipo ?></td>
                                                    <td><?= $a->total ?></td>
                                                    <td><?= $a->fechareg ?></td>
                                                    <td><?= $a->glosa ?></td> 
                                                    <td style="color: <?= $a->color ?>"><?= $a->estadosituacion ?></td> 
                                                    <td>
                                                        <i style="cursor: pointer" data-feather="edit" data-bs-toggle="modal" data-bs-target="#edit-close-modal" class="icon-dual" onclick="form_editar('formeditaradelanto',<?= $a->idadelanto ?>)"></i> 
                                                    </td>
                                                </tr> 
                                                <?php } ?> 
                                            </tbody>
