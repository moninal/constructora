                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title" style="font-weight: bold">ALQUILER DE EQUIPOS</h4>
                                        <p class="text-muted font-13 mb-1">
                                            Muestra del listado de registros ingresados por alquiler de equipos
                                        </p>

                                        <a onclick="form_nuevo('formnuevoalquiler')" id="myBtn" type="button" class="btn btn-sm btn-success waves-effect waves-light float-end" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                        ...
                                        <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <i style="cursor: pointer" data-feather="edit" data-bs-toggle="modal" data-bs-target="#edit-close-modal" class="icon-dual" onclick="form_editar('formeditaralquiler',<?= $a->idalquiler ?>)"></i>
                                                        <i style="cursor: pointer" data-feather="trash-2" class="icon-dual" data-bs-toggle="modal" data-bs-target="#borrar-close-modal"onclick="borrar('borraralquiler','alquiler',<?= $a->idalquiler ?>)"></i>
                                                    </td>
                                                </tr> 
                                                <?php } ?> 
                                            </tbody>
