                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <a onclick="form_nuevo('formnuevociudad')" id="myBtn" type="button" class="btn btn-sm btn-success waves-effect waves-light float-end" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                            <i style="color: white" data-feather="plus" class="icon-dual"></i>   
                                        </a>  
                                        <h4 class="header-title" style="font-weight: bold">CIUDAD</h4>
                                        <p class="text-muted font-13 mb-1">
                                            Muestra del listado de registros de ciudades locales
                                        </p>
                                        <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                            ...
                                            <tbody> 
                                                <?php $cont=0; foreach ($ciudad as $c) { $cont++; ?>
                                                <tr>
                                                    <td><?= $cont ?></td>
                                                    <td><?= $c->descripcion ?></td> 
                                                    <td><?= $c->estado ?></td> 
                                                    <td> <i style="cursor: pointer" data-feather="edit" data-bs-toggle="modal" data-bs-target="#edit-close-modal" class="icon-dual" onclick="form_editar('formeditarciudad',<?= $c->idciudad ?>)"></i>
                                                    <i style="cursor: pointer" data-feather="trash-2" class="icon-dual" data-bs-toggle="modal" data-bs-target="#borrar-close-modal"onclick="borrar('borrarciudad','ciudad',<?= $c->idciudad ?>)"></i></td> 
                                                </tr>
                                                <?php } ?> 
                                            </tbody>
                                        </table>
