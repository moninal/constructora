                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <a onclick="form_nuevo('formnuevoactividad')" id="myBtn" type="button" class="btn btn-sm btn-success waves-effect waves-light float-end" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                            <i style="color: white" data-feather="plus" class="icon-dual"></i>   
                                        </a>  
                                        <h4 class="header-title" style="font-weight: bold">ACTIVIDAD</h4>
                                        <p class="text-muted font-13 mb-1">
                                            Muestra del listado de actividades para el registro del proyecto
                                        </p>
                                        <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                            ...
                                            <tbody> 
                                                <?php $cont=0; foreach ($actividad as $a) { $cont++; ?>
                                                <tr>
                                                    <td><?= $cont ?></td>
                                                    <td><?= $a->descripcion ?></td>  
                                                    <td> <i style="cursor: pointer" data-feather="edit" data-bs-toggle="modal" data-bs-target="#edit-close-modal" class="icon-dual" onclick="form_editar('formeditaractividad',<?= $a->idactividad ?>)"></i>
                                                    <i style="cursor: pointer" data-feather="trash-2" class="icon-dual" data-bs-toggle="modal" data-bs-target="#borrar-close-modal"onclick="borrar('borraractividad','actividad',<?= $a->idactividad ?>)"></i></td> 
                                                </tr>
                                                <?php } ?> 
                                            </tbody>
                                        </table>
