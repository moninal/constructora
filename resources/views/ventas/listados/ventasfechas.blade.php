                        ...
                        <div class="row">
                          <form   enctype="multipart/form-data"  name="fileinfo">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="modal-title">Consulta de ventas por fechas</h4>
                                            <div  class="row">    
                                                <div class="col-lg-2"> 
                                                        <label class="form-label">Fecha Inicio</label>
                                                        <input id="fechainicio" class="block mt-1 w-full form-control"  type="date" name="fechainicio" :value="old('fechainicio')" required autofocus > 
                                                </div>   
                                                <div class="col-lg-2"> 
                                                        <label class="form-label">Fecha Fin</label>
                                                        <input id="fechafinal" class="block mt-1 w-full form-control"  type="date" name="fechafinal" :value="old('fechafinal')" required autofocus > 
                                                </div>
                                                <div class="col-lg-2">  
                                                    <a id="consultar" style="color: white" onclick="tconsultafalta('buscarventasfechas')" class="btn btn-info waves-effect waves-light">Consultar</a>
                                                </div>
                                            </div>   
