...
<head>
    ...
    <body data-layout-mode="default" data-theme="light" data-layout-width="fluid" data-topbar-color="dark" data-menu-position="fixed" data-leftbar-color="light" data-leftbar-size='default' data-sidebar-user='false'>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body"> 
                                        <h4 class="header-title mb-4">Ventas</h4>
                                        <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                            ...
                                            <tbody> 
                                                <?php $cont=0; foreach ($venta as $v ) { $cont++; ?>
                                                <tr>
                                                    <td><?= $cont ?></td>
                                                    <td><?= $v->documento.' '.$v->serie.'-'.$v->correlativo ?></td>
                                                    <td><?= $v->cliente ?></td> 
                                                    <td><?= $v->cantidad ?></td> 
                                                    <td><?= $v->total ?></td> 
                                                    <td><?= $v->fechareg ?></td>  
                                                    <td><span class="badge label-table <?= $v->estadocolor ?>"><?= $v->estadositu ?></span></td>  
                                                    <td> 
                                                        <i data-feather="clipboard" data-bs-toggle="modal" data-bs-target="#item-close-modal" class="icon-dual" onclick="ver('ver_venta','<?= $v->idventa ?>')"></i>
                                                        <i data-feather="trash-2" class="icon-dual" data-bs-toggle="modal" data-bs-target="#borrar-close-modal"onclick="borrar('borrar_venta','anularventa',<?= $v->idventa ?>)"></i>
                                                    </td> 
                                                </tr>
                                                <?php } ?> 
                                            </tbody>
        ...
        @extends('ventas.operaciones.anularventa.modal') 
        <!-- END wrapper -->
    </body>
